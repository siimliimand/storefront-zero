					...
					<div class="entry-meta mt-3 text-sm text-gray-500">
						...
						<span class="byline">
							...
							printf(
								...
								'<span class="author vcard"><a class="url fn n text-brand-600 hover:underline" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a></span>'
							);
							?>
						</span>
					</div>
